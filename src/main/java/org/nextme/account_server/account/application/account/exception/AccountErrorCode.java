...
public enum AccountErrorCode {
    ...
    ACCOUNT_DELETE_FAILED(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "삭제 실패하였습니다."),
    ACCOUNT_ERROR_CODE(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "응답코드가 없습니다."),
    ACCOUNT_ALREADY_DELETE(HttpStatus.BAD_REQUEST, "BAD_REQUEST","이미 삭제되었습니다.");
