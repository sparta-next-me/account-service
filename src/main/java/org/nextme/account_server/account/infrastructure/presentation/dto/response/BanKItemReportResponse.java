...
@Builder
public record BanKItemReportResponse(
        UUID bankItemId, // 금융상품 아이디
    ...
    public static BanKItemReportResponse of(BankItem bankItem) {
        return BanKItemReportResponse.builder()
                .bankItemId(bankItem.getBankItemId().getId())
